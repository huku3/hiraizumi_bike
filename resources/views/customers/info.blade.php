...
<head>
    ...
    <style>
        body {
            background-image: url('{{ Storage::url('images/infos/IMG_3673.jpg') }}');
...
<body>
    ...
    <h1>平泉スワローツアー</h1>
        <h2 class="text-4xl font-semibold">レンタルサイクルサービス（仮）</h2>
    ...
    <section class="bg-black bg-opacity-70 text-white py-8 px-4 md:px-24 mb-4 rounded-lg">
        <h2 class="text-2xl font-semibold mb-4">レンタル料金案内</h2>
        {{-- <p class="mb-4">料金:</p> --}}
    ...
    <section class="bg-black bg-opacity-70 text-white py-8 px-4 md:px-24 mb-4 rounded-lg">
        <h2 class="text-2xl font-semibold mb-4">アクセス</h2>
